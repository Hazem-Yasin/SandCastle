...
using Quartz;
using Quick_Application1.Core.Infrastructure;
using Quick_Application1.Core.Models.Account;
using Quick_Application1.Core.Services;
using Quick_Application1.Core.Services.Account;
using Quick_Application1.Core.Services.Shop;
using Quick_Application1.Server.Authorization;
using Quick_Application1.Server.Authorization.Requirements;
using Quick_Application1.Server.Configuration;
using Quick_Application1.Server.Services;
using Quick_Application1.Server.Services.Email;
